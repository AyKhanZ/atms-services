...
{
    // System Roles
    public static readonly Guid SuperAdmin = Guid.Parse("cc4b9105-86b8-49ca-9b2f-260551aa675f");
    ...
    public static readonly Guid Employee = Guid.Parse("58a8f620-1550-41a2-8693-336fd9bbeb53");
