        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Projects_ProjectKinds_ProjectKindId",
                        column: x => x.ProjectKindId,
                        principalTable: "ProjectKinds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProjectGroups_Level", "\"Level\" <= 1");
                    table.ForeignKey(
                        name: "FK_ProjectGroups_ProjectGroups_ParentWorkGroupId",
                        column: x => x.ParentWorkGroupId,
                        principalTable: "ProjectGroups",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectGroups_Projects_WorkProjectId",
                        column: x => x.WorkProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectGroups_WorkGroupStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "WorkGroupStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectParticipants_Projects_WorkProjectId",
                        column: x => x.WorkProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectParticipantRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectParticipantRoles_ProjectParticipants_WorkProjectPart~",
                        column: x => x.WorkProjectParticipantId,
                        principalTable: "ProjectParticipants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectParticipantRoles_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_ProjectGroups_WorkGroupId",
                        column: x => x.WorkGroupId,
                        principalTable: "ProjectGroups",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_ProjectParticipants_AssigneeId",
                        column: x => x.AssigneeId,
                        principalTable: "ProjectParticipants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_Projects_WorkProjectId",
                        column: x => x.WorkProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_WorkItemPriorities_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "WorkItemPriorities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_WorkTaskStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "WorkTaskStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_WorkTicketStatuses_WorkTicketStatusId",
                        column: x => x.WorkTicketStatusId,
                        principalTable: "WorkTicketStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_WorkTicketTypes_WorkTicketTypeId",
                        column: x => x.WorkTicketTypeId,
                        principalTable: "WorkTicketTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkTicketId = table.Column<Guid>(type: "uuid", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedById = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedById = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Meetings_Projects_WorkProjectId",
                        column: x => x.WorkProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Meetings_Tickets_WorkTicketId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Tasks_Level", "\"Level\" <= 1");
                    table.ForeignKey(
                        name: "FK_Tasks_ProjectParticipants_AssigneeId",
                        column: x => x.AssigneeId,
                        principalTable: "ProjectParticipants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tasks_Projects_WorkProjectId",
                        column: x => x.WorkProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tasks_Tickets_WorkTicketId",
                        column: x => x.WorkTicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tasks_WorkItemPriorities_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "WorkItemPriorities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tasks_WorkTaskStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "WorkTaskStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeetingParticipants_ProjectParticipants_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_OwnerType_OwnerId_CreatedAt",
                table: "Attachments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingMinutes_MeetingId_Order",
                table: "MeetingMinutes",
                columns: new[] { "MeetingId", "Order" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MeetingParticipants_MeetingId_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Meetings_WorkProjectId_StartsAt",
                table: "Meetings",
                columns: new[] { "WorkProjectId", "StartsAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Meetings_WorkTicketId",
                table: "Meetings",
                column: "WorkTicketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectGroups_ParentWorkGroupId",
                table: "ProjectGroups",
                column: "ParentWorkGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectGroups_StatusId",
                table: "ProjectGroups",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectParticipantRoles_RoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_ProjectKindId",
                table: "Projects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_WorkGroupId",
                table: "Tickets",
                column: "WorkGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_WorkProjectId",
                table: "Tickets",
                column: "WorkProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_WorkTicketStatusId",
                table: "Tickets",
                column: "WorkTicketStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_WorkTicketTypeId",
                table: "Tickets",
