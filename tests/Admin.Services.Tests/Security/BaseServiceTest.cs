...
public abstract class BaseServiceTest
{
    ...
    protected const int MaxRefreshExpirationInDays = 90;
    ...
    protected IConfiguration BuildConfiguration()
    {
        var jwtSettings = new Dictionary<string, string?>
        {
            ...
            [$"{nameof(JwtOptions)}:{nameof(JwtOptions.MaxRefreshTokenLifetimeExpirationInDays)}"] = MaxRefreshExpirationInDays.ToString(),
